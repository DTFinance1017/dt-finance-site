...
export function Services() {
  return (
    <section id="solucoes" className="py-16 md:py-24 lg:py-32 bg-white relative">
      <div className="max-w-[1440px] mx-auto px-6 sm:px-10 lg:px-16 relative">
        <FadeIn className="text-center mb-16">
          <p className="text-xs font-semibold text-[#1B4158]/32 uppercase tracking-widest mb-5">Soluções</p>
          <h2
